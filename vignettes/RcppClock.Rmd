---
title: "Using RcppClock"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{RcppClock}
...
You may load it into your R session using `library(RcppClock)`, but more commonly you will load the header library into Rcpp functions:
...
On the R end, we can now do stuff with the "naptimes" variable:
